...
const CRYPTOBOOKZ = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-black text-slate-600 items-center justify-center">
      ...
      <header className="flex w-full items-center justify-between justify-center sm:items-center h-20 gap-x-2 px-4 border-b-2 border-b-indigo-500/50  ">
        {/*BUTTON-FRAME*/}
        <button
          disabled
          className={
            "disabled:bg-slate-500 disabled:hover:text-black rounded-md text-blue bg-blue-400 px-4 py-2 w-1/5 hover:bg-blue-400 hover:text-white hover:shadow-blue-500 hover:border-indigo-500/50 text-slate-700 active:text-indigo-700 shadow-lg shadow-cyan-500/50 active:shadow-indigo-500"
          }
          onClick={() => {
            loadBooks_TitleMain();
          }}
        ...
        <maintitle
          className="flex text-md md:text-2xl"
          style={{ "fontFamily": "fantasy" }}
        >
          C R Y P T O B O O K Z
          <div className="ml-2 hover:shadow-indigo-500 hover:shadow-blue-100">
            {/*icon*/}
      ...
      <footer className="flex h-12 w-full px-2 md:px-10 justify-between items-center justify-center border-t-2 border-t-indigo-500/50">
        ...
        <booknav className="flex w-auto justify-between justify-center items-center">
          <button
            className={
              "disabled:bg-slate-500 rounded-md text-blue bg-blue-400 px-4 py-1 my-1 hover:bg-blue-400 hover:text-white hover:shadow-blue-500 hover:border-indigo-500/50 text-slate-700 active:text-indigo-700 shadow-lg shadow-cyan-500/50 active:shadow-indigo-500"
            }
            onClick={() => {
              loadBook_TitleLast();
            }}
          ...
          <booknum className="mx-1 sm:mx-4">
            {" "}
